CREATE TABLE IF NOT EXISTS advising_appointments (
    ...
    adviser_user_id BIGINT NULL REFERENCES users(id) ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS advising_notes (
    ...
    institution_id BIGINT NOT NULL REFERENCES institutions(id) ON DELETE CASCADE,
    student_profile_id BIGINT NOT NULL REFERENCES student_profiles(id) ON DELETE CASCADE,
    appointment_id BIGINT NULL REFERENCES advising_appointments(id) ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS advising_tasks (
    ...
    public_id TEXT NOT NULL UNIQUE,
    institution_id BIGINT NOT NULL REFERENCES institutions(id) ON DELETE CASCADE,
    student_profile_id BIGINT NULL REFERENCES student_profiles(id) ON DELETE SET NULL,
